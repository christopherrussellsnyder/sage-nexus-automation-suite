...
const AgencyDashboard = () => {
  ...
  // Load leads from LeadManagement component
  useEffect(() => {
  ...
  const handleNurtureLead = (lead: any) => {
    ...
    toast({
      title: "Lead Nurtured",
      description: `Follow-up actions initiated for ${lead.name}`,
    });
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveSection('leads')}>
          ...
          <CardContent>
            <CardDescription className="mb-4">
              Add and manage leads with AI-powered scoring and automatic qualification
            </CardDescription>
            <div className="flex items-center justify-between text-sm">
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setActiveSection('lead-scoring')}>
          ...
          <CardContent>
            <CardDescription className="mb-4">
              AI-powered lead scoring with nurturing recommendations and engagement tracking
            </CardDescription>
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500">{leads.filter(l => l.score >= 80).length} hot leads</span>
